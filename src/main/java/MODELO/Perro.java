...
public class Perro  extends Object {
  ...
  private String per_des; 
    ...
    public Perro(int per_id, String per_nom, int cra_id, int tpd_id, Timestamp per_cum, int ref_id, long per_img, int orp_id, String per_des ) {
        super();
        this.per_id = per_id;
    ...
    public Perro(int per_id, String per_nom, int cra_id, int tpd_id, Timestamp per_cum, int ref_id, long per_img, int orp_id, String per_des, int id) {
        super(id);
        this.per_id = per_id;
        this.per_nom = per_nom;
        this.cra_id = cra_id;
